...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1404: (a, i) => a.push(i),
      _1405: (a, i) => a.splice(i, 1)[0],
      _1408: a => a.pop(),
      _1409: (a, i) => a.splice(i, 1),
      _1410: (a, s) => a.join(s),
      _1411: (a, s, e) => a.slice(s, e),
      _1413: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1414: a => a.length,
      _1416: (a, i) => a[i],
      _1417: (a, i, v) => a[i] = v,
      _1419: o => {
      ...
      _1442: (t, s) => t.set(s),
      _1443: l => new DataView(new ArrayBuffer(l)),
      ...
      _1567: (x0,x1) => new WebSocket(x0,x1),
      _1568: (x0,x1) => x0.send(x1),
      _1569: (x0,x1,x2) => x0.close(x1,x2),
      _1570: (x0,x1) => x0.close(x1),
      _1571: x0 => x0.close(),
      _1572: x0 => new BroadcastChannel(x0),
      ...
      _1575: x0 => x0.close(),
      _1576: () => new AbortController(),
      _1577: x0 => x0.abort(),
      _1578: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1579: (x0,x1) => globalThis.fetch(x0,x1),
      _1580: (x0,x1) => x0.get(x1),
      _1581: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1581(f,arguments.length,x0,x1,x2) }),
      _1582: (x0,x1) => x0.forEach(x1),
      _1583: x0 => x0.getReader(),
      _1584: x0 => x0.cancel(),
      _1585: x0 => x0.read(),
      _1586: x0 => x0.ready(),
      _1587: x0 => x0.expand(),
      _1588: x0 => x0.disableVerticalSwipes(),
      _1589: (x0,x1) => x0.openTelegramLink(x1),
      _1590: x0 => x0.initData,
      _1591: x0 => x0.initDataUnsafe,
      ...
      _1614: () => globalThis.document,
      _1620: (x0,x1) => { x0.height = x1 },
      _1622: (x0,x1) => { x0.width = x1 },
      _1631: x0 => x0.style,
      _1634: x0 => x0.src,
      _1635: (x0,x1) => { x0.src = x1 },
      _1636: x0 => x0.naturalWidth,
      _1637: x0 => x0.naturalHeight,
      _1653: x0 => x0.status,
      _1654: (x0,x1) => { x0.responseType = x1 },
      _1656: x0 => x0.response,
      ...
      _3823: x0 => x0.href,
      _3938: x0 => x0.userAgent,
      _3989: x0 => x0.data,
      _4036: (x0,x1) => { x0.onmessage = x1 },
      _4143: x0 => x0.length,
      _4360: x0 => x0.readyState,
      _4373: (x0,x1) => { x0.binaryType = x1 },
      _4376: x0 => x0.code,
      _4377: x0 => x0.reason,
      _6085: x0 => x0.signal,
      _7921: x0 => x0.value,
